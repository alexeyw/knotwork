...
/**
 * An imported pipeline whose id already names a pipeline in the library.
 *
 ...
 * the author's to choose — and everything bound to that id, which Replace
 * hands over to the imported graph.
 *
 * @property incoming The imported graph, checked and ready to persist.
 * @property existingName The library pipeline's current name.
 * @property bindings What is bound to the shared id today.
 */
